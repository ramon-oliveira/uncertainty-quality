...
class MotorolaBattery(Dataset):

    def __init__(self, *args, **kwargs):
        super(MotorolaBattery, self).__init__('classification', *args, **kwargs)
        x_train = np.load('data/motorola_battery/x_train.npy')
        y_train = np.load('data/motorola_battery/y_train.npy')
        x_test = np.load('data/motorola_battery/x_test.npy')
        y_test = np.load('data/motorola_battery/y_test.npy')
